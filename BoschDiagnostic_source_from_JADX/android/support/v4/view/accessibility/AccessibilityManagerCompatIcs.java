...
class AccessibilityManagerCompatIcs {
    ...
    static class C00311 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C00311(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
