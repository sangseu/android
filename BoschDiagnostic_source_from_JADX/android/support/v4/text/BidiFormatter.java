            ...
            while (this.charIndex < this.length && firstNonEmptyEmbeddingLevel == 0) {
                switch (dirTypeForward()) {
                    ...
                    case C0102R.styleable.Spinner_disableChildrenWhenDisabled /*9*/:
                        break;
                    case C0102R.styleable.MenuItem_actionLayout /*14*/:
                    case C0102R.styleable.MenuItem_actionViewClass /*15*/:
                        embeddingLevel += BidiFormatter.DIR_RTL;
                        embeddingLevelDir = BidiFormatter.DIR_LTR;
                        break;
                    case TransportMediator.FLAG_KEY_MEDIA_PAUSE /*16*/:
                    case C0102R.styleable.ActionBar_progressBarPadding /*17*/:
                        embeddingLevel += BidiFormatter.DIR_RTL;
                        embeddingLevelDir = BidiFormatter.DIR_RTL;
                        break;
                    case C0102R.styleable.ActionBar_itemPadding /*18*/:
