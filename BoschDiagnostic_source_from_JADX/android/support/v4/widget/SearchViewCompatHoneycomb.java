...
class SearchViewCompatHoneycomb {
    ...
    static class C00411 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00411(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00422 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00422(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
