...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    class C00713 implements Runnable {
        C00713() {
        }
    ...
    class C00724 implements OnFocusChangeListener {
        C00724() {
        }
    ...
    class C00735 implements OnLayoutChangeListener {
        C00735() {
        }
    ...
    class C00746 implements OnGlobalLayoutListener {
        C00746() {
        }
    ...
    class C00757 implements OnClickListener {
        C00757() {
        }
    ...
    class C00768 implements OnKeyListener {
        C00768() {
        }
    ...
    class C00779 implements OnEditorActionListener {
        C00779() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mShowImeRunnable = new C00691();
        this.mUpdateDrawableStateRunnable = new C00702();
        this.mReleaseCursorRunnable = new C00713();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C00757();
        this.mTextKeyListener = new C00768();
        this.mOnEditorActionListener = new C00779();
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0048R.layout.abc_search_view, this, true);
        this.mSearchButton = findViewById(C0048R.id.search_button);
        this.mQueryTextView = (SearchAutoComplete) findViewById(C0048R.id.search_src_text);
        ...
        this.mSubmitButton = findViewById(C0048R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0048R.id.search_close_btn);
        this.mVoiceButton = findViewById(C0048R.id.search_voice_btn);
        this.mSearchHintIcon = (ImageView) findViewById(C0048R.id.search_mag_icon);
        ...
        this.mQueryTextView.setOnFocusChangeListener(new C00724());
        TypedArray a = context.obtainStyledAttributes(attrs, C0048R.styleable.SearchView, 0, 0);
        ...
        a.recycle();
        a = context.obtainStyledAttributes(attrs, C0048R.styleable.View, 0, 0);
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C00735());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C00746());
    }
    ...
    private int getSearchIconId() {
        ...
        getContext().getTheme().resolveAttribute(C0048R.attr.searchViewSearchIcon, outValue, true);
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0048R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0048R.dimen.abc_dropdownitem_text_padding_left) : 0;
