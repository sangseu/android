...
public class ActionBarView extends AbsActionBarView {
    ...
    private static class HomeView extends FrameLayout {
        ...
        protected void onFinishInflate() {
            this.mUpView = (ImageView) findViewById(C0048R.id.up);
            this.mIconView = (ImageView) findViewById(C0048R.id.home);
    ...
    static class SavedState extends BaseSavedState {
        ...
        static class C00571 implements Creator<SavedState> {
            C00571() {
            }
    ...
    class C01221 implements OnItemSelectedListener {
        C01221() {
        }
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        this.mNavItemSelectedListener = new C01221();
        this.mExpandedActionViewUpListener = new C00552();
        this.mUpClickListener = new C00563();
        this.mContext = context;
        setBackgroundResource(DISPLAY_DEFAULT);
        TypedArray a = context.obtainStyledAttributes(attrs, C0048R.styleable.ActionBar, C0048R.attr.actionBarStyle, DISPLAY_DEFAULT);
        ...
        int homeResId = a.getResourceId(14, C0048R.layout.abc_action_bar_home);
        ...
        this.mExpandedHomeLayout.setContentDescription(getResources().getText(C0048R.string.abc_action_bar_up_description));
    ...
    public void initProgress() {
        ...
        this.mProgressView.setId(C0048R.id.progress_horizontal);
    ...
    public void initIndeterminateProgress() {
        ...
        this.mIndeterminateProgressView.setId(C0048R.id.progress_circular);
        ...
        if (this.mSplitActionBar != splitActionBar) {
            ...
            if (this.mActionMenuPresenter != null) {
                if (splitActionBar) {
                    ...
                    this.mActionMenuPresenter.setExpandedActionViewsExclusive(getResources().getBoolean(C0048R.bool.abc_action_bar_expanded_action_views_exclusive));
                }
            }
    ...
    public void setMenu(SupportMenu menu, MenuPresenter.Callback cb) {
        if (menu != this.mOptionsMenu) {
            ...
            if (this.mActionMenuPresenter == null) {
                ...
                this.mActionMenuPresenter.setId(C0048R.id.action_menu_presenter);
    ...
    public void setHomeButtonEnabled(boolean enable) {
        ...
        if (!enable) {
            ...
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0048R.string.abc_action_bar_up_description));
        } else {
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0048R.string.abc_action_bar_home_description));
        }
    }
            ...
            switch (mode) {
                case CursorAdapter.FLAG_AUTO_REQUERY /*1*/:
                    if (this.mSpinner == null) {
                        this.mSpinner = new SpinnerICS(this.mContext, null, C0048R.attr.actionDropDownStyle);
                        this.mListNavLayout = (LinearLayout) LayoutInflater.from(this.mContext).inflate(C0048R.layout.abc_action_bar_view_list_nav_layout, null);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            boolean homeAsUp;
            boolean showHome;
            this.mTitleLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(C0048R.layout.abc_action_bar_title_item, this, false);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0048R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0048R.id.action_bar_subtitle);
            this.mTitleUpView = this.mTitleLayout.findViewById(C0048R.id.up);
