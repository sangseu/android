...
abstract class AbsActionBarView extends ViewGroup {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0048R.styleable.ActionBar, C0048R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(1, 0));
        a.recycle();
        if (this.mSplitWhenNarrow) {
            setSplitActionBar(getContext().getResources().getBoolean(C0048R.bool.abc_split_action_bar_is_narrow));
        }
    ...
    public void animateToVisibility(int visibility) {
        ...
        if (visibility != getVisibility()) {
            Animation anim = AnimationUtils.loadAnimation(getContext(), visibility == 0 ? C0048R.anim.abc_fade_in : C0048R.anim.abc_fade_out);
            startAnimation(anim);
