...
class SpinnerICS extends AbsSpinnerICS implements OnClickListener {
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleRes) {
            ...
            setOnItemClickListener(new OnItemClickListenerWrapper(new C01231(SpinnerICS.this)));
        }
    ...
    SpinnerICS(Context context, int mode) {
        this(context, null, C0048R.attr.spinnerStyle, mode);
    }

    SpinnerICS(Context context, AttributeSet attrs) {
        this(context, attrs, C0048R.attr.spinnerStyle);
    }
    ...
    SpinnerICS(Context context, AttributeSet attrs, int defStyle, int mode) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0048R.styleable.Spinner, defStyle, MODE_DIALOG);
        if (mode == MODE_THEME) {
