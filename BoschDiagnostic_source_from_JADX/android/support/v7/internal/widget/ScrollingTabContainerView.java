...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemClickListener {
    ...
    public static class TabView extends LinearLayout {
        ...
        public void update() {
            ...
            if (text != null) {
                if (this.mTextView == null) {
                    TextView textView = new CompatTextView(getContext(), null, C0048R.attr.actionBarTabTextStyle);
    ...
    public ScrollingTabContainerView(Context context) {
        ...
        this.mTabLayout = (LinearLayout) this.mInflater.inflate(C0048R.layout.abc_action_bar_tabbar, this, false);
    ...
    private SpinnerICS createSpinner() {
        SpinnerICS spinner = new SpinnerICS(getContext(), null, C0048R.attr.actionDropDownStyle);
    ...
    public void animateToTab(int position) {
        ...
        this.mTabSelector = new C00671(tabView);
    ...
    private TabView createTabView(Tab tab, boolean forAdapter) {
        TabView tabView = (TabView) this.mInflater.inflate(C0048R.layout.abc_action_bar_tab, this.mTabLayout, false);
