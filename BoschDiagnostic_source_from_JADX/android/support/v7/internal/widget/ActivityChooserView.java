...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C00591 extends DataSetObserver {
        C00591() {
        }
    ...
    class C00602 implements OnGlobalLayoutListener {
        C00602() {
        }
    ...
    class C00613 extends DataSetObserver {
        C00613() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case ITEM_VIEW_TYPE_ACTIVITY /*0*/:
                    if (convertView == null || convertView.getId() != C0048R.id.list_item) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0048R.layout.abc_activity_chooser_view_list_item, parent, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo activity = (ResolveInfo) getItem(position);
                    ((ImageView) convertView.findViewById(C0048R.id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0048R.id.title)).setText(activity.loadLabel(packageManager));
                ...
                case ITEM_VIEW_TYPE_FOOTER /*1*/:
                    if (convertView == null || convertView.getId() != ITEM_VIEW_TYPE_FOOTER) {
                        ...
                        ((TextView) convertView.findViewById(C0048R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0048R.string.abc_activity_chooser_view_see_all));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetOberver = new C00591();
        this.mOnGlobalLayoutListener = new C00602();
        this.mInitialActivityCount = 4;
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0048R.styleable.ActivityChooserView, defStyle, 0);
        ...
        LayoutInflater.from(getContext()).inflate(C0048R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (LinearLayout) findViewById(C0048R.id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0048R.id.default_activity_button);
        ...
        this.mExpandActivityOverflowButton = (FrameLayout) findViewById(C0048R.id.expand_activities_button);
        this.mExpandActivityOverflowButton.setOnClickListener(this.mCallbacks);
        this.mExpandActivityOverflowButtonImage = (ImageView) this.mExpandActivityOverflowButton.findViewById(C0048R.id.image);
        ...
        this.mAdapter.registerDataSetObserver(new C00613());
    ...
    private void showPopupUnchecked(int maxActivityCount) {
        ...
        if (!popupWindow.isShowing()) {
            ...
            popupWindow.getListView().setContentDescription(getContext().getString(C0048R.string.abc_activitychooserview_choose_application));
        }
    }
