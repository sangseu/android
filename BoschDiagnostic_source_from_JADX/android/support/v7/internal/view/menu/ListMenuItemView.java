...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0048R.styleable.MenuView, defStyle, 0);
    ...
    protected void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0048R.id.title);
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0048R.layout.abc_list_menu_item_icon, this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0048R.layout.abc_list_menu_item_radio, this, false);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0048R.layout.abc_list_menu_item_checkbox, this, false);
