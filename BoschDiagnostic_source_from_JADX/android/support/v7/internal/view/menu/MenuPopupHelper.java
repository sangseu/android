...
public class MenuPopupHelper implements OnItemClickListener, OnKeyListener, OnGlobalLayoutListener, OnDismissListener, MenuPresenter {
    ...
    static {
        ITEM_LAYOUT = C0048R.layout.abc_popup_menu_item_layout;
    }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
        ...
        this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0048R.dimen.abc_config_prefDialogWidth));
    ...
    public boolean tryShow() {
        ...
        this.mPopup = new ListPopupWindow(this.mContext, null, C0048R.attr.popupMenuStyle);
